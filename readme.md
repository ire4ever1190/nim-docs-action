...
- [x] Build docs for multiple versions
...
- `versions`: Versions to build docs for. You can also specify `HEAD` for latest commit and `stable` for version specified in the latest nimble file
